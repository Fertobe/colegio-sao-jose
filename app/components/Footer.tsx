 ...
 */
const EMAIL = process.env.NEXT_PUBLIC_CONTATO_EMAIL ?? "contato@colegiosaojose.net";
...
export default function Footer() {
  return (
    <footer className="border-t bg-white" aria-labelledby="rodape-heading">
      {/* Landmark oculto para tecnologias assistivas */}
      ...
      <div className="mx-auto grid max-w-6xl gap-6 px-4 py-8 md:grid-cols-3">
        ...
        <div>
          ...
          {/* Redes sociais */}
          <div className="mt-4 flex items-center gap-3" aria-label="Redes sociais">
            {/* YouTube */}
            <a
              href={YOUTUBE}
              target="_blank"
        ...
        <nav aria-label="Institucional">
          ...
          <ul className="mt-3 space-y-2 text-sm">
            <li>
              <Link href="/institucional/nossa-historia" prefetch={false}>
                Sobre
              </Link>
            </li>
            <li>
              <Link href="/noticias" prefetch={false}>
                Notícias
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/politica-de-cookies" prefetch={false}>
                Política de Cookies
              </Link>
            </li>
          </ul>
        ...
        <nav aria-label="Contato">
          ...
          {/* Address melhora semântica para dados de contato */}
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                ...
                >
                  ...
                  <span>
                    Como chegar <span className="sr-only">— {ADDRESS}</span>
                  </span>
                </a>
              </li>
              <li>
