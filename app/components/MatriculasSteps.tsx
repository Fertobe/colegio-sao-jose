              ...
              <>
                <div className="flex items-start gap-3">
                  ...
                  <h3 className="text-[22px] md:text-[26px] font-extrabold text-brand-900 leading-snug">
                    Me interessei pelo colégio. <br />Como eu entro em contato?
                  </h3>
                </div>
                ...
                <ul className="mt-4 space-y-4 text-brand-900/90 text-[16px] md:text-[17px] leading-8">
                  ...
                  <li className="flex items-center gap-3">
                    ...
                    <strong className="text-brand-900">{centralTelefone}</strong>.
                  </li>
                </ul>
                ...
                <div className="mt-5">
                  ...
                  >
                    <svg viewBox="0 0 32 32" className="mr-2 h-[18px] w-[18px]" fill="currentColor">
