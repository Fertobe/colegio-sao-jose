...
export default function ContatoFormMailto({ email }: { email: string }) {
  ...
  const buildMailto = (to: string, subjectRaw: string, bodyRaw: string) => {
    // usa CRLF para compatibilidade ampla
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // tenta abrir o app de e-mail do dispositivo
    window.location.href = href;

    // reabilita o botão caso o handler retorne
